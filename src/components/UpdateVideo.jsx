...
import { useGetVideoQuery, useUpdateVideoMutation } from '../features/adminPortal/videos/videosApi';
...
const UpdateVideo = () => {
    ...
    const [updateVideo,{data,isSuccess:updateSuccess}]=useUpdateVideoMutation()
    useEffect(() => {
    ...
    const handleupdateVideo = (e) => {
        e.preventDefault();
        const dt={title,description,url,views,duration};
        updateVideo({id:updateVideoId,data:dt})
    }
