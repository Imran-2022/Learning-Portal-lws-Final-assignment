                ...
                <div>
                    <form onSubmit={handleEditQuiz}>
                        <div className="border-b border-gray-900/10 pb-12 bg-white w-8/12 m-auto p-4 mt-16">
                            ...
                            {/* Submit button */}
                            <div className=" mt-4 inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm  bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                <button type="submit">
                                    Update quiz
                                </button>
                            </div>
