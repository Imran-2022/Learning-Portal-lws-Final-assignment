...
const EditQuiz = () => {
    ...
    useEffect(() => {
        ...
        setOption1(singleQuiz?.options[0])
        setOption2(singleQuiz?.options[1])
        setOption3(singleQuiz?.options[2])
        setOption4(singleQuiz?.options[3])
    }, [singleQuiz])
                        ...
                        <div className="border-b border-gray-900/10 pb-12 bg-white w-8/12 m-auto p-4 mt-16">
                            <div className=" grid grid-cols-1 gap-y-3 gap-x-6 sm:grid-cols-6 ">
                                ...
                                <div className="sm:col-span-4">
                                    ...
                                    <div className="mt-2">
                                        <select
                                            ...
                                            className="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  focus:outline-none  sm:text-sm sm:leading-6"
                                        >
                                            <option selected hidden disabled  value={JSON.stringify({video_id:singleQuiz?.video_id,video_title:singleQuiz?.video_title})}>{singleQuiz?.video_title}</option>
                                            {
                                ...
                                <div className="sm:col-span-4">
                                    ...
                                    <div className="mt-2 flex gap-3">
                                        <input type="radio" name="option4" id="" checked={option4?.isCorrect||false} onClick={e => setOption4({ ...option4, isCorrect: !option4.isCorrect })} />
                                        <input
